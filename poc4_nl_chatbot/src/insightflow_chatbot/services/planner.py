...
from insightflow_chatbot.services.planner_context import PlannerContext
...
class QuestionPlanner:
    ...
    def _build_prompt(self, question: str, context: PlannerContext) -> str:
        ...
        return (
            ...
            "dimension_values: if the question limits itself to specific values of a dimension (for example "
            "\"customers in AL, RN and CE\" or \"revenue for electronics\"), list those values exactly as "
            "written; otherwise leave it empty. Always fill it when it applies, even if you also plan a "
            "group_by.\n\n"
