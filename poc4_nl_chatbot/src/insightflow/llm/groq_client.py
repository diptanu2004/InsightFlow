"""Vendored, unmodified, from poc1_schema_discovery/src/insightflow/llm/groq_client.py.
Same ChatGroq + json_mode structured-output approach POC 1 already proved out; POC 3 reuses it
verbatim for DashboardPlanner rather than inventing a second LLM-calling convention.
"""
